...
const ConfirmModalLayout: React.FC<ModalLayoutProps> = ({
  isOpen,
  onClose,
  header,
  children,
  ...
  return (
    ...
    >
      <div className="bg-white w-full max-w-[480px] max-h-[85vh] flex flex-col shadow-lg drop-shadow-lg border border-[#EBEDEF] rounded-xl mb-6">
        {header && (
